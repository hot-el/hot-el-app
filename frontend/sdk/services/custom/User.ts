...
export class UserApi extends BaseLoopBackApi {
  ...
  /**
   * Znajdź pokrewny element wg identyfikatora dla accessTokens.
   *
   * @param {any} id User id
   *
   * @param {any} fk Klucz obcy dla accessTokens
   *
  ...
  /**
   * Usuń pokrewny element wg identyfikatora dla accessTokens.
   *
   * @param {any} id User id
   *
   * @param {any} fk Klucz obcy dla accessTokens
  ...
  /**
   * Zaktualizuj pokrewny element wg identyfikatora dla accessTokens.
   *
   * @param {any} id User id
   *
   * @param {any} fk Klucz obcy dla accessTokens
  ...
  /**
   * Odpytuje element accessTokens w User.
   *
   * @param {any} id User id
   *
   * @param {object} filter 
  ...
  /**
   * Tworzy nową instancję w elemencie accessTokens tego modelu.
   *
   * @param {any} id User id
   *
   * @param {object} data Request data.
  ...
  /**
   * Usuwa wszystkie accessTokens tego modelu.
   *
   * @param {any} id User id
   *
   * @returns {object} An empty reference that will be
  ...
  /**
   * Zlicza elementy accessTokens w User.
   *
   * @param {any} id User id
   *
   ...
   *   from the server.
   *
   * Treść odpowiedzi zawiera właściwości elementu AccessToken utworzonego przy logowaniu.
